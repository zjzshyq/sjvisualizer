...
class axis():
    def __init__(self, canvas, x=0, y=0, length=1000, width=1000, orientation="horizontal", n=3, allow_decrease=False, tick_length=0, is_log_scale=False, is_date=False, color=(50,50,50), font_size=25, text_font="Microsoft JhengHei UI", time_indicator="year", line_tickness=2, ticks_only=True, unit="", tick_prefix=""):
        self.canvas = canvas
        self.x = x
        self.y = y
        self.length = length
